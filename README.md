...
Loosely speaking with have: `/<datatype>/<id>.<format>` and support csv and json file formats. You can also look at the file structure at https://github.com/GSA/sdg-data-usa/tree/gh-pages and it shows how it's all laid out.
...
The main data set, the raw data lives in `/data-wide/` in the repo.

e.g. https://GSA.github.io/sdg-data-usa/data-wide/1-2-1.csv

At build time, this "wide" data is made "tidy" and put in the `/data/` folder.
...
Data is under [Creative Commons Zero v1.0 Universal](http://creativecommons.org/publicdomain/zero/1.0/).
